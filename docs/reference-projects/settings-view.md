        ...
        return (
          <div className="fade-in animate-in space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <select className={inputClass} defaultValue="1994">
                        <option>1994</option>
                      </select>
                    </div>
                  </div>
                  <div>
                    ...
                    <select
                      className={inputClass}
                      defaultValue={CURRENT_USER.gender}
                    >
                      <option>Male</option>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mb-2 rounded border border-gray-200 bg-gray-50 p-3 text-gray-600 text-sm">
                    1177 Jersey Ave, Morgantown, West Virginia 26505 USA
                    <br />
                    <span className="font-bold">Public Profile Location:</span>{" "}
                    Morgantown, WV, USA
                  </div>
                  <button className="font-medium text-blue-600 text-sm hover:underline">
                    Edit your Address
                  </button>

                  {/* Deprecated Notice */}
                  <div className="mt-4 rounded border border-gray-200 bg-gray-100 p-4 text-gray-700 text-sm">
                    <p className="mb-1 font-bold text-green-600">
                      Thank you so much for verifying!
                    </p>
                    <p className="mb-2">
                      We are deprecating address verification by December 15,
                      2025. Please verify your address prior to that date if you
                      wish too.
                    </p>
                    ...
                    <p className="mb-2 text-gray-500 text-xs">
                      Postcard sent on April 30, 2018 to 1177 Jersey Ave...
                      Expected delivery 2018-05-07.
                    </p>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    className={inputClass}
                    defaultValue="Nathan Lawer-Yolar"
                    type="text"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    className={inputClass}
                    defaultValue="natyolar@hotmail.com"
                    type="email"
                  />
                </div>
                <div>
            ...
            <div className="flex justify-between border-gray-200 border-t pt-6">
              ...
              <button className="font-medium text-red-500 text-sm hover:underline">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        >
                          {social.connected
                            ? "Connected as Chibuzor Ejimofor"
                            : "Not connected"}
                        </p>
                      </div>
                    </div>
